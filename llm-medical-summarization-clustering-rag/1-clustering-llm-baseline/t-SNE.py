...
#df.to_csv("tSNE-embedding-NC3.csv", index=False)

kmeans = cluster.KMeans(n_clusters=3)
y_pred = kmeans.fit_predict(embedding)

patient_dataset2["t-SNE_kmeans_labels"]=y_pred
...
plt.xlabel("t-SNE First Component", fontsize=12)
plt.ylabel("t-SNE Second Component", fontsize=12)
plt.show()
